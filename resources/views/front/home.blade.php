...
<style>
    ...
    .elite-product{border:1px solid #e8dccb;border-radius:18px;background:#fff;overflow:hidden;display:grid;grid-template-columns:120px minmax(0,1fr);gap:12px;padding:10px}
    ...
    .elite-product-desc{margin:0;color:#6f675a;font-size:.82rem;line-height:1.6}
    ...
    .elite-add-btn{border:none;border-radius:12px;padding:9px 13px;font-size:.8rem;font-weight:900;color:#fff;background:linear-gradient(135deg,#103f33,#2f7562)}
