...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Alexandria:wght@400;500;600;700;800;900&family=Manrope:wght@500;600;700;800&display=swap" rel="stylesheet">
    <x-analytics />
    ...
    @php
        ...
        if (file_exists($manifestPath)) {
            ...
            $hasFrontPremiumEntry = isset($manifest['resources/css/front-premium-theme.css']);
            $hasAppJsEntry = isset($manifest['resources/js/app.js']);
        }
    @endphp

    @if($hasFrontLayoutEntry && $hasFrontThemeEntry && $hasFrontPremiumEntry && $hasAppJsEntry)
        @vite(['resources/css/front-layout.css', 'resources/css/front-theme.css', 'resources/css/front-premium-theme.css', 'resources/js/app.js'])
    @else
